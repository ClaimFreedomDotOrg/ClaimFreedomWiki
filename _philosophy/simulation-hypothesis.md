...
- [Quantum Consciousness](/philosophy/quantum-consciousness) — The "1" and "0" superposition
- [Māyā vs. Kenoma](/philosophy/kenoma-pleroma) — The benign illusion vs. the prison
- [The Voice vs. The Listener](/philosophy/voice-listener) — Who is observing the simulation?
- [Perennial Philosophy](/philosophy/perennial-philosophy) — The "game" encoded across traditions
- [Daemon vs. Demon](/philosophy/daemon-demon) — Functional vs. hijacked simulation

### Examples

- [The Matrix](/examples/the-matrix) — Gnostic cinema par excellence
- [The Truman Show](/examples/the-truman-show) — Solipsistic simulation
- [Inception](/examples/inception) — Layered realities and the totem question

### Neuroscience

- [What is the DMN?](/neuroscience/what-is-dmn) — Your neurological simulation engine
- [DMN and the Narrative Self](/neuroscience/dmn-narrative-self) — How the brain constructs "you"

### Practices

- [Watching the Watcher](/practices/watching-the-watcher) — Observing the observer
- [The V-Aum Protocol](/practices/v-aum-protocol) — Instant gnosis beyond the simulation
...
- Nick Bostrom (2003), *"Are You Living in a Computer Simulation?"* — [Philosophical Quarterly](https://simulation-argument.com/simulation.pdf)
