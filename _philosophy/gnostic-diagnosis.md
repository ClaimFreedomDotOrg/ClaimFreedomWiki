...
1. **A mask**: It impersonates the true Self
2. **A voice**: It speaks as if it *is* you ("I am anxious," "I am unworthy")
3. **A jailer**: It keeps the Divine Spark locked in forgetfulness
...
1. **Recollection** (*anamnesis*): Remembering your divine origin
2. **Dis-identification**: Seeing the counterfeit spirit as *object* (not subject)
3. **Awakening**: The Divine Spark recognizes itself
...
See [Resources](/docs/resources) for translations and scholarly analysis.
