...
1. **Body-identification** (pleasure/pain, craving/aversion)
2. **Spiritual bypassing** (ego co-opting awakening)
3. **Worldly striving** (ego-empire building)
...
1. **Somatic craving**: "If you were really okay, you wouldn't need this (food/drink/substance/distraction)."
2. **Spiritual bypassing**: "You're so advanced; you don't need therapy/rest/boundaries."
3. **Power-seeking**: "Forget presence—chase success/control/influence."
...
- **[Voice vs. Listener](/philosophy/voice-listener)** — Satan as the Voice attempting dominance
- **[Daemon vs. Demon](/philosophy/daemon-demon)** — "Get behind me" = repositioning tyrant to servant
- **[Counterfeit Spirit](/philosophy/counterfeit-self)** — The Voice impersonating you
- **[The Hijacking Process](/philosophy/hijacking-process)** — Counter-attack after Gnosis

### Neuroscience

- **[DMN Narrative Self](/neuroscience/dmn-narrative-self)** — The Voice's seductive narratives
- **[Salience Network](/neuroscience/salience-network)** — Jesus' capacity to recognize and resist
- **[Chronic Stress](/neuroscience/chronic-stress)** — Wilderness as disrupting autopilot patterns

### Practices

- **[Observing the Voice](/practices/observing-the-voice)** — Recognizing the three temptation strategies
- **[Taming Your DMN](/practices/taming-your-dmn)** — "Get behind me, Satan" = repositioning the Voice
- **[Loving the Dragon](/practices/loving-the-dragon)** — Compassion for the Voice's strategies (not destroying, repositioning)
- **[Daily Integration](/practices/daily-integration)** — Ministering to yourself after resistance

### Related Biblical Decodings

- **[Get Behind Me, Satan](/biblical/get-behind-me-satan)** — Same Satan, same command (Voice must serve, not rule)
- **[The Garden of Eden](/biblical/garden-eden)** — The serpent's temptation = original hijacking
- **[The Prodigal Son](/biblical/prodigal-son)** — "Reckless living" = succumbing to the kingdoms temptation
- **[The Narrow Gate](/biblical/narrow-gate)** — Resisting temptation = choosing the difficult path
- **[Born Again](/biblical/born-again)** — Baptism (Gnosis) → Wilderness (testing) → Rebirth (integration)
...
1. **Satan/Devil = the Voice** (hijacked DMN, counterfeit spirit, Demon), not external entity.

2. **The wilderness = contemplative solitude** where the Voice's strategies become undeniable.

3. **The three temptations = the Voice's primary hijacking strategies**: somatic craving (bread), spiritual bypassing (temple), power-seeking (kingdoms).

4. **The pattern**: Gnosis (baptism) → Counter-attack (wilderness temptation) → Resistance (dis-identification) → Integration (angels minister).

5. **Jesus demonstrates the practice**: Recognize the Voice's strategy → Quote anchoring truth → Refuse identification → Command the Voice to serve ("Get behind me").

6. **Expect intensification after breakthroughs.** The hijacking counter-attacks when threatened. This is normal.

7. **Fasting (literal/metaphorical) reveals dependencies.** Remove habitual inputs to see the Voice's strategies clearly.

8. **Use anchoring statements** (scripture or personalized) to interrupt the Voice's narratives.

9. **Minister to yourself after resistance.** Rest, integrate, allow nervous system regulation before reengaging.

10. **The wilderness is not punishment but training.** Face-to-face with the dragon, you learn to tame it.
