...
1. **Name the experience** ("I must not fear")
2. **Recognize the pattern** ("Fear is the mind-killer")
3. **Accept impermanence** ("I will permit it to pass")
4. **Engage observation** ("I will turn the inner eye")
5. **Recognize the Observer's continuity** ("Only I will remain")
...
1. **Name it**: "Fear is present." (Not "I am afraid"—fear is **object**, not subject)

2. **Recognize its nature**: "This is a pattern. This is the DMN's threat response. This is temporary."

3. **Allow passage**: "I will not suppress it or fight it. I will let it move through." (Breath—long exhales signal safety to nervous system)

4. **Turn the inner eye**: "Who is observing this fear? Who is aware that fear is present?" (The Listener, the Observer, the Spark—**this is you**)

5. **Note impermanence**: "Fear arises. Fear dissolves. The Observer remains."

6. **Return to body**: Feel feet on ground, hands in lap. You are **here, now, safe enough** to practice.

7. **If needed, repeat**: The Litany is **not one-and-done**. It's a **mantra for the duration of the wave**.
...
- [Fear and the Amygdala](/neuroscience/fear-amygdala)
- [Dis-identification Practice](/practices/disidentification)
- [Integration After Awakening](/practices/integration)
