...
**This is the Sacred Order** (see [The Sacred Order](/philosophy/sacred-order) and [John 14:20](/biblical/that-day-you-will-realize)):
...
**Practices**: [Programming the Daemon](/philosophy/programming-daemon), [Daily Integration](/practices/daily-integration)
...
**Practices**: [Story Disidentification](/practices/story-disidentification), [Resist Not Evil](/biblical/resist-not-evil)
...
**Practices**: [V-Aum Protocol](/practices/v-aum-protocol), [Witness Meditation](/practices/witness-meditation), [Heart Listening](/practices/heart-listening)
...
- **[The Sacred Order](/philosophy/sacred-order)** — Source → Listener → Daemon (the mutual indwelling)
- **[The Divine Spark](/philosophy/divine-spark)** — The Spirit (Pneuma) within
- **[Flow State Conduction](/neuroscience/flow-state-conduction)** — The neurological circuit of mutual indwelling

### Practices

- **[V-Aum Protocol](/practices/v-aum-protocol)** — Access the Stillpoint (verify the Spirit)
- **[Witness Meditation](/practices/witness-meditation)** — Anchor in The Listener (verify the Spirit)
- **[Heart Listening](/practices/heart-listening)** — Receive the Source's call (verify the Spirit)
- **[Command Training](/practices/command-training)** — Live from the Spirit, command the Daemon
