...
1. **External stimulus** (someone insults you, wrongs you, attacks you)
2. **The Voice reacts** ("This is wrong! I am hurt! I must defend/attack!")
3. **You identify with the Voice** ("I am angry. I must retaliate.")
4. **You act from identification** (revenge, defensiveness, rumination)
5. **The loop perpetuates** (the other person reacts, you react to their reaction, endless cycle)
...
1. **Stimulus**: Someone insults you (slaps you)
2. **The Voice reacts**: "How dare they! I must respond!"
3. **Dis-identification**: "That is the Voice reacting. I am not the Voice. I am the Listener."
4. **Spacious response**: From the Listener, you **choose** how to respond (or not respond) without being **driven** by reactivity
...
1. **Strengthen the hijacking** (the Voice dominates more)
2. **Perpetuate the loop** (your reaction triggers their reaction, etc.)
3. **Become like what you resist** (you embody the same reactivity you oppose)
...
1. **Notice** the Voice's narratives arising ("They don't deserve it," "I need to protect my resources")
2. **Dis-identify** ("Those are thoughts. I am not those thoughts.")
3. **Respond from the Listener** (freely choose to give or not give, but from spacious awareness, not reactive protection)
...
- **[Samsara](/philosophy/samsara)** — The reactivity loop as the cycle of suffering
- **[The Voice vs. The Listener](/philosophy/voice-listener)** — Reactivity vs. spacious response
- **[The Hijacking Process](/philosophy/hijacking-process)** — How the Voice's automatic program takes over
- **[Liberation](/philosophy/liberation)** — Freedom from the reactivity loop

### Neuroscience

- **[DMN and Rumination](/neuroscience/rumination)** — The Voice's post-trigger narrative generation
- **[Chronic Stress](/neuroscience/chronic-stress)** — How reactivity damages the body
- **[Salience Network](/neuroscience/salience-network)** — The Listener's capacity to interrupt reactivity

### Practices

- **[Observing the Voice](/practices/observing-the-voice)** — Dis-identifying from reactivity
- **[Body as Anchor](/practices/body-anchor)** — Grounding when triggered
- **[Loving the Dragon](/practices/loving-the-dragon)** — Compassion for the reactive Voice
- **[Trauma Work](/practices/trauma-work)** — Working with deeply embedded reactivity patterns

### Related Biblical Decodings

- **[The Narrow Gate](/biblical/narrow-gate)** — Breaking the reactivity loop is the "hard" path
- **[Eyes to See, Ears to Hear](/biblical/eyes-ears)** — Perceiving beyond automatic reactivity
- **[Born Again](/biblical/born-again)** — Ego-death = death of automatic reactivity
- **[Get Behind Me, Satan](/biblical/get-behind-me-satan)** — Jesus resisting the Voice's reactivity
...
1. **"Resist not evil" = Refuse to identify with the Voice's automatic reactivity** when triggered by harm, injustice, or attack.

2. **The reactivity loop = Samsara.** Action-reaction, tit-for-tat, endless cycling. Breaking the loop requires **dis-identification**.

3. **Turning the other cheek = Dis-identifying from the Voice's reactivity**, responding (or not responding) from the **Listener's spacious freedom**.

4. **Resistance feeds the loop.** When you react from identification with the Voice, you perpetuate the cycle and become like what you resist.

5. **This is not passivity or doormat theology.** It is **supreme strength**—the freedom to respond wisely rather than being enslaved to automatic reactivity.

6. **The practice**: Notice the trigger → Dis-identify from the Voice's reactivity → Respond (or don't) from the Listener.

7. **Going the second mile = Acting from freedom, not compulsion.** The first mile is slavery (to external force or internal reactivity). The second mile is liberation.
