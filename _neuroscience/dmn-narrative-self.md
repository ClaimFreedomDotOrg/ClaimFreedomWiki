...
- **Dis-identification practices** (like [Observing the Voice](/practices/observing-the-voice) and [Self-Inquiry](/practices/self-inquiry)) interrupt DMN dominance and reveal the **Listener** (pure awareness) beneath the narrative
...
See: [DMN in Depression](/neuroscience/dmn-depression), [DMN in Anxiety](/neuroscience/dmn-anxiety)
...
See: [The Counterfeit Self](/philosophy/counterfeit-self), [Avidya](/philosophy/avidya)
...
**This is the "loop of hell"** described in [Part III: The Loop](/docs/the-loop).
...
See: [Daemon vs. Demon](/philosophy/daemon-demon), [Taming Your DMN](/practices/taming-your-dmn)
...
- **Intervention**: Dis-identification practices ([Observing the Voice](/practices/observing-the-voice)) + behavioral activation (engage Task-Positive Network)

### For Anxiety

- **Catastrophizing** = DMN future-projection ("I will fail")
- **Intervention**: Ground in present moment ([Body as Anchor](/practices/body-anchor)) + question the narrative ([Self-Inquiry](/practices/self-inquiry))

### For Trauma

- **PTSD narratives** = DMN locked in threat-based stories ("The world is unsafe; I am broken")
- **Intervention**: Trauma-informed practices ([Working with Trauma](/practices/trauma-work)) + gradual dis-identification
...
- [What is the DMN?](/neuroscience/what-is-dmn)
- [DMN and Self-Referential Thought](/neuroscience/dmn-self-reference)
- [DMN Hyperactivity](/neuroscience/dmn-hyperactivity)
- [Meditation Effects on DMN](/neuroscience/meditation-dmn)
...
- [Dis-Identifying from Story](/practices/story-disidentification)
